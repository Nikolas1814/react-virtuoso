...
var VirtuosoList = /*#__PURE__*/React.memo(function () {
...
var DEFAULT_STYLE = {};
var VirtuosoPresentation = /*#__PURE__*/React.memo(function (_ref) {
...
var Virtuoso = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  useImperativeHandle(ref, function () {
    return {
      ...
      remainScrollPosition: function remainScrollPosition(currentTopIndex, newElementsCount) {
      ...
      prependItems: function prependItems(newElementsCount) {
        return new Promise(function (resolve, reject) {
          window.requestAnimationFrame(function () {
            if (!state.currentTotal.val) return reject();
            var current = state.currentTotal.val || 0;
            var newSize = current + newElementsCount;
            state.currentTotal.val = newSize; //console.log('start total', state.currentTotal.val, current)

            state.totalCount(newSize); //console.log('start index', state.currentRange.startIndex)
      ...
      appendItems: function appendItems(newElementsCount, scrollToBottom) {
        return new Promise(function (resolve, reject) {
          if (!state.currentTotal.val) return reject();
          var current = state.currentTotal.val || 0;
          var newSize = current + newElementsCount;
  ...
  }, [state, props.scrollingStateChange, props.atBottomStateChange, props.endReached, props.topItems, //props.totalCount,
  props.initialItemCount, props.itemsRendered, props.totalListHeightChanged, props.followOutput, props.maxHeightCacheSize, props.rangeChanged, props.scrollSeek, props.item, props.ItemContainer, props.computeItemKey, props.dataKey]);
  useEffect(function () {
...
var GroupedVirtuoso = /*#__PURE__*/forwardRef(function (props, ref) {
